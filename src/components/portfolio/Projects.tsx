...
const projects = [
  ...
  },
  {
    ...
    title: "STUDYFLOW",
    cat: "CODE / WEB",
    desc: "A study helper web app to plan sessions, track tasks, and stay locked in. Clean UI, focus-first flow.",
    tags: ["React", "Productivity", "Web"],
    href: "https://studyflow-shr.lovable.app",
  },
  {
    n: "03",
    title: "RANK GRIND",
