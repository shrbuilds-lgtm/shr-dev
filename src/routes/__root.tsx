...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SRIHARI — Student · Gamer · Editor" },
      { name: "description", content: "Portfolio of Srihari — student, gamer, video editor and computer enthusiast. Cyberpunk-inspired creative work." },
      { name: "author", content: "Srihari" },
      { property: "og:title", content: "SRIHARI — Portfolio" },
      { property: "og:description", content: "Student. Gamer. Editor. Code." },
